      ...
      <div className="w-full max-w-md">
        <div className="ai-card p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">EightFaces: Soft Skills Engine</h1>
          ...
          <div className="space-y-4">
            {/* Google Login Button */}
            <Button
              className="w-full flex items-center justify-center gap-3 h-12 ai-button"
          ...
          <div className="mt-8 text-center">
            <div className="flex items-center justify-center gap-2 text-sm text-muted-foreground">
              ...
              <span>Безопасный вход через OAuth</span>
            </div>
          </div>
        </div>
